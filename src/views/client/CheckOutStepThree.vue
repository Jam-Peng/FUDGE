            ...
            <div class="p-4 py-2">
              <div class="col-lg-6 ms-auto orderItem_text text-secondary">
                ...
                <div class="row mb-1">
                  ...
                  <!-- <span class="col text-end" v-if="order.total < 1000">{{
                    shippingFee
                  }}</span>
                  <span class="col text-end" v-else>0</span> -->
                  <span
                ...
                <div class="row mb-1">
                  <div class="text-end">
                    ...
                    <!-- <span class="col text-end" v-if="shippingFee === 80"
                    >NT.{{ $filters.currency(order.total + shippingFee) }}</span
                  > -->
                    <span class="fs-3"
          ...
          <div class="row">
            ...
            >
              ...
              <div class="receiverForm">
                ...
                <div class="col-md-12 mb-2 px-2 orderItem_text">
                  <span
                    >取貨門市：{{ locationName }} - {{ locationAddress }}</span
                  >
                </div>
              </div>
            </div>
